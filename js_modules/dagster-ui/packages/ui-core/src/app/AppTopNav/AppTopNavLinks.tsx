...
export const navLinks = () => {
  ...
  const canvas = {
    ...
    path: '/canvas',
    element: (
      <TopNavLink to="/canvas" data-cy="AppTopNav_StatusLink" >
        <Box flex={{direction: 'row', alignItems: 'center', gap: 6}}>Canvas</Box>
      </TopNavLink>
    ),
  };
  ...
  if (featureEnabled(FeatureFlag.flagSettingsPage)) {
    ...
    return [overview, assets, jobs, automation, runs, deployment, canvas];
  }
  ...
  return [overview, runs, assets, deployment, canvas];
};
